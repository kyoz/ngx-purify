...
export const CHATBOX_CONTACTS: ChatboxContact[] = [
  ...
  { id: 5, name: 'Willodean Lilley', status: 'do-not-disturb', unreadCount: 0, avatar: 'willodean.jpg' },
  { id: 6, name: 'Penny Hefley', status: 'busy', unreadCount: 0, avatar: 'penny.jpg' },
  { id: 7, name: 'Halen Pennington', status: 'online', unreadCount: 0, avatar: 'halen.jpg' },
  { id: 8, name: 'Madelyn Decker', status: 'offline', unreadCount: 0, avatar: 'madelyn.jpg' },
  { id: 9, name: 'Christian Pittman', status: 'online', unreadCount: 0, avatar: 'christian.jpg' },
  { id: 10, name: 'Marietta Hereford', status: 'do-not-disturb', unreadCount: 0, avatar: 'marrietta.jpg' },

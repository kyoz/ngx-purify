...
export const CHATBOX_CONVERSASIONS: IChatBoxConversation[] = [
  {
    ...
    withContact: 1,
    messages: [
      { id: 11, sender: 1, message: `How's going bro ? How's going bro ? How's going bro ?`, createAt: new Date('2018-04-11T10:20:30Z') },
      { id: 12, sender: 0, message: `Not too bad How's going bro ? How's going bro ? How's going bro ?`, createAt: new Date('2018-04-11T10:20:30Z') },
      { id: 13, sender: 1, message: `Are you free this weekend ? How's going bro ? How's going bro ? How's going bro ?`, createAt: new Date('2018-04-11T10:20:30Z') },
      { id: 14, sender: 1, message: `I do have some cool project for us How's going bro ? How's going bro ? How's going bro ?`, createAt: new Date('2018-04-11T10:20:30Z') },
      { id: 15, sender: 1, message: `You'll definitely like it, haha`, createAt: new Date('2018-04-11T10:20:30Z') },
      { id: 16, sender: 0, message: `Well, sound interesting How's going bro ? How's going bro ? How's going bro ?`, createAt: new Date('2018-04-11T10:20:30Z') },
      { id: 17, sender: 0, message: `But i do have sdfdsf How's going bro ? How's going bro ?`, createAt: new Date('2018-04-11T10:20:30Z') },
      { id: 18, sender: 0, message: `sfsdfsdfsdfsfd' How's going bro ? How's going bro ?`, createAt: new Date('2018-04-11T10:20:30Z') },
      { id: 19, sender: 0, message: 'ssssssssssfffffffff fffffffff', createAt: new Date('2018-04-11T10:20:30Z') },
      { id: 10, sender: 1, message: 'sdfffffffffffffffff', createAt: new Date('2018-04-11T10:20:30Z') },
    ]
  },
  {
    owner: 0,
    withContact: 2,
    messages: [
      { id: 21, sender: 2, message: 'Hello 1', createAt: new Date('2018-04-11T10:20:30Z') },
      { id: 22, sender: 0, message: 'Hello 2', createAt: new Date('2018-04-11T10:20:30Z') },
      { id: 23, sender: 2, message: 'Hello 3', createAt: new Date('2018-04-11T10:20:30Z') },
      { id: 24, sender: 2, message: 'Hello 4', createAt: new Date('2018-04-11T10:20:30Z') },
      { id: 25, sender: 2, message: 'Hello 5', createAt: new Date('2018-04-11T10:20:30Z') },
      { id: 26, sender: 0, message: 'Hello 6', createAt: new Date('2018-04-11T10:20:30Z') },
      { id: 27, sender: 0, message: 'Hello 7', createAt: new Date('2018-04-11T10:20:30Z') },
    ]
  }
];
